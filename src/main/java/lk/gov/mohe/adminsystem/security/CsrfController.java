 ...
 * <p>
 * Provides endpoints for the frontend to retrieve CSRF tokens
...
public class CsrfController {
     ...
     * that must be included in subsequent requests to protected endpoints.
     * <p>
     * The token is automatically set as a cookie (XSRF-TOKEN) and can also
     * be retrieved via this endpoint for manual inclusion in requests.
     *
