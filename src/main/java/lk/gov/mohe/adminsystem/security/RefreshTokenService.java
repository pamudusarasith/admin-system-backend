...
public class RefreshTokenService {
     ...
     * Implements token rotation by revoking old tokens if limit is exceeded.
     */
    @Transactional
     ...
     * This method decodes the JWT and checks the JTI against stored values.
     */
    ...
    /**
     * Revokes a refresh token and its entire token family (all tokens derived from
     * rotation).
     * This is used when token reuse is detected for security.
     */
    @Transactional
    public void revokeTokenFamily(RefreshToken token) {
        ...
        log.warn("Revoked token family for user: {} due to security violation",
