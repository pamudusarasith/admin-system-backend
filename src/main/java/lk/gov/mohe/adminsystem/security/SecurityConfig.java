...
public class SecurityConfig {
    ...
    JwtDecoder jwtDecoder() {
        NimbusJwtDecoder jwtDecoder =
            NimbusJwtDecoder.withPublicKey(this.publicKey).build();
        Map<String, Converter<Object, ?>> claimNameToConverter = new HashMap<>();
        claimNameToConverter.put("userId",
            userId -> userId != null ? Integer.parseInt(userId.toString()) : null);
        claimNameToConverter.put("divisionId",
            divisionId -> divisionId != null ? Integer.parseInt(divisionId.toString())
                : null);
