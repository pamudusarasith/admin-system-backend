...
public class Authorities {
    public static final GrantedAuthority letterReadAll = new SimpleGrantedAuthority(
        "letter:read:all");
    ...
    public static final GrantedAuthority letterReadOwn = new SimpleGrantedAuthority(
        "letter:read:own");
}
